package com.app.clinicdiarydemo.alamview;

import static com.app.clinicdiarydemo.alamview.WeekViewUtil.isSameDay;
import static com.app.clinicdiarydemo.alamview.WeekViewUtil.today;
...
public class WeekView extends View {
    ...
    private List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> mPreviousPeriodEvents;
    private List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> mCurrentPeriodEvents;
    private List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> mNextPeriodEvents;
    ...
    private com.app.clinicdiarydemo.alamview.WeekViewLoader mWeekViewLoader;
     ...
     */
    private void drawEventTitle(com.app.clinicdiarydemo.alamview.WeekViewEvent event, RectF rect, Canvas canvas, float originalTop, float originalLeft) {
    ...
    private class EventRect {
        public com.app.clinicdiarydemo.alamview.WeekViewEvent event;
        public com.app.clinicdiarydemo.alamview.WeekViewEvent originalEvent;
        public RectF rectF;
        public float left;
        public float width;
        public float top;
         ...
         */
        public EventRect(com.app.clinicdiarydemo.alamview.WeekViewEvent event, com.app.clinicdiarydemo.alamview.WeekViewEvent originalEvent, RectF rectF) {
            this.event = event;
            this.rectF = rectF;
    ...
    private void getMoreEvents(Calendar day) {
        ...
        if (mWeekViewLoader != null) {
            ...
            if (!isInEditMode() && (mFetchedPeriod < 0 || mFetchedPeriod != periodToFetch || mRefreshEvents)) {
                List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> previousPeriodEvents = null;
                List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> currentPeriodEvents = null;
                List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> nextPeriodEvents = null;
     ...
     */
    private void cacheEvent(com.app.clinicdiarydemo.alamview.WeekViewEvent event) {
        if (event.getStartTime().compareTo(event.getEndTime()) >= 0)
            return;
        List<com.app.clinicdiarydemo.alamview.WeekViewEvent> splitedEvents = event.splitWeekViewEvents();
        for (com.app.clinicdiarydemo.alamview.WeekViewEvent splitedEvent : splitedEvents) {
     ...
     */
    private void sortAndCacheEvents(List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> events) {
        sortEvents(events);
        for (com.app.clinicdiarydemo.alamview.WeekViewEvent event : events) {
            cacheEvent(event);
        }
    }
     ...
     */
    private void sortEvents(List<? extends com.app.clinicdiarydemo.alamview.WeekViewEvent> events) {
        Collections.sort(events, new Comparator<com.app.clinicdiarydemo.alamview.WeekViewEvent>() {
            @Override
            public int compare(com.app.clinicdiarydemo.alamview.WeekViewEvent event1, com.app.clinicdiarydemo.alamview.WeekViewEvent event2) {
     ...
     */
    private boolean isEventsCollide(com.app.clinicdiarydemo.alamview.WeekViewEvent event1, com.app.clinicdiarydemo.alamview.WeekViewEvent event2) {
        long start1 = event1.getStartTime().getTimeInMillis();
        long end1 = event1.getEndTime().getTimeInMillis();
        long start2 = event2.getStartTime().getTimeInMillis();
        long end2 = event2.getEndTime().getTimeInMillis();
     ...
     */
    public com.app.clinicdiarydemo.alamview.WeekViewLoader getWeekViewLoader() {
     ...
     * </p>
     *
     * @param length Supported values are {@link com.app.clinicdiarydemo.alamview.WeekView#LENGTH_SHORT} and
     *               {@link com.app.clinicdiarydemo.alamview.WeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    public interface EventClickListener {
         ...
         */
        void onEventClick(com.app.clinicdiarydemo.alamview.WeekViewEvent event, RectF eventRect);
    }

    public interface EventLongPressListener {
        /**
         * Similar to {@link com.app.clinicdiarydemo.alamview.WeekView.EventClickListener} but with a long press.
         *
         * @param event:     event clicked.
         * @param eventRect: view containing the clicked event.
         */
    ...
    public interface EmptyViewLongPressListener {
        /**
         * Similar to {@link com.app.clinicdiarydemo.alamview.WeekView.EmptyViewClickListener} but with long press.
         *
